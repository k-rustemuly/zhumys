...
use App\Domain\Ranging\Service\Interview as Service;
...
final class InterviewAction
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, $args): ResponseInterface
    {
        ...
        $this->service->interview($args["lang"], (int)$args["id"], (int)$args['ranging_id'], $post);
        $this->language->locale($args["lang"]);
        return $this->responder->success($response, $this->language->get("success")["Ranging success sended interview"]);
    }
}
