...
use App\Domain\Ranging\Service\Accept as Service;
...
final class AcceptAction {
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, $args): ResponseInterface{
        ...
        $this->service->accept((int)$args["id"], (int)$args['ranging_id'], $post);
        $this->language->locale($args["lang"]);
        return $this->responder->success($response, $this->language->get("success")["Ranging success accepted"]);
    }
}
