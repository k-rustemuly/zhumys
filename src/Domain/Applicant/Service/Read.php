...
final class Read{
    ...
    public static function getHeader() :array{
        return array(
            ...
            "phone_number" => Field::getInstance()->init(new PhoneNumber())->is_required(true)->can_update(true)->execute(),
            "address" => Field::getInstance()->init(new Textarea())->can_update(true)->is_required(true)->execute(),
            "second_phone_number" => Field::getInstance()->init(new Textarea())->can_update(true)->execute(),
