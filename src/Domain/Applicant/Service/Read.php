...
final class Read{
    ...
    public static function getHeader() :array{
        return array(
            ...
            "full_name" => Field::getInstance()->init(new Text())->can_create(true)->can_change(true)->is_required(true)->min_length(3)->execute(),
            ...
            "phone_number" => Field::getInstance()->init(new PhoneNumber())->is_required(true)->can_change(true)->execute(),
            "address" => Field::getInstance()->init(new Textarea())->can_change(true)->is_required(true)->execute(),
            ...
            "comment" => Field::getInstance()->init(new Textarea())->can_create(true)->can_change(true)->execute(),
        );
    }
}